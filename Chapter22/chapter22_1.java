...
class CellPhone
{
    ...
    public CellPhone(boolean camera_included)
    {
        this(camera_included,"","","");
    }
    
    public CellPhone(boolean camera_included, String model)
    {
        this(camera_included,model,"","");
    }
    
    public CellPhone(boolean camera_included, String model, String manufacturer)
    {
        this(camera_included,model,manufacturer,"");
    }
    
    public CellPhone(boolean camera_included, String model, String manufacturer, String color)
    {
